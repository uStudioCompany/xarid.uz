...
[](/schema/definitions/codelists/tenderStatuses.csv "Статусы закупочного проекта")
[](/schema/definitions/codelists/tenderStatusDetails.csv "Детали статуса закупочного проекта")
### Структура модели 
